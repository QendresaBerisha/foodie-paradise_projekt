        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <table class="tbl-30">
                <tr>
                    <td>Titulli: </td>
                    <td>
                        <input type="text" name="title" placeholder="Titulli i Kategorise">
                    </td>
                </tr>

                <tr>
                    <td>Selekto nje Fotogafi: </td>
                    <td>
        ...
        <?php 
            ...
            if(isset($_POST['submit']))
            {
                ...
                if($res==true)
                {
                    ...
                    $_SESSION['add'] = "<div class='success'>Kategoria eshte shtuar me sukses!</div>";
                ...
                else
                {
                    ...
                    $_SESSION['add'] = "<div class='error'>Kemi deshtuar te shtojme Kategorine!</div>";
                    //Redirect to Manage Category Page
                    header('location:'.SITEURL.'admin/add-category.php');
                }
            }
